...
//This annotation is used to indicate that the class is a MongoDB document.
//collection = "movies":
// it specifies that instances of the Movie class should be stored in the movies collection in MongoDB.
@Document("movies")
public class Movie {
